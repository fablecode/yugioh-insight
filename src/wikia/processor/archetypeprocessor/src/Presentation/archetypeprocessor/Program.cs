...
using archetypeprocessor.application;
using archetypeprocessor.application.Configuration;
using archetypeprocessor.Extensions.WindowsService;
using archetypeprocessor.infrastructure;
using archetypeprocessor.Services;
        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            return new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    // hosted service
                    services.AddHostedService<ArchetypeProcessorHostedService>();
