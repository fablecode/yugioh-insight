...
namespace banlistprocessor.domain.unit.tests.BanlistServiceTests
{
    ...
    public class UpdateBanlistTests
    {
        ...
        public async Task Given_A_YugiohBanlist_Should_Invoke_GetBanlistById_Method_Once()
        {
            ...
            var yugiohBanlist = new YugiohBanlist{ BanlistType = BanlistType.Tcg};
        ...
        public void Given_A_YugiohBanlist_If_Format_Is_Not_Found_Should_Throw_ArgumentException()
        {
            ...
            // Act
            Func<Task<Banlist>> act = () => _sut.Update(yugiohBanlist);
        ...
        [Test]
        public async Task Given_A_YugiohBanlist_Should_Invoke_BanlistRepository_Update_Method_Once()
        {
            // Arrange
            const int expected = 1;
            var yugiohBanlist = new YugiohBanlist();
            ...
            // Assert
            await _banlistRepository.Received(expected).Update(Arg.Any<Banlist>());
        }
