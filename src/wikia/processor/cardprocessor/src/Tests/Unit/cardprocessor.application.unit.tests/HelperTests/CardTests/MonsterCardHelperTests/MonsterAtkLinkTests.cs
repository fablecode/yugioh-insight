...
namespace cardprocessor.application.unit.tests.HelperTests.CardTests.MonsterCardHelperTests
{
    ...
    public class MonsterAtkLinkTests
    {
        [Test]
        public void Given_A_Valid_A_Link_Monster_YugiohCard_With_An_Atk_Should_Extract_Atk_Value()
        {
            // Arrange
            ...
            // Act
            var result = MonsterCardHelper.AtkLink(yugiohCard);
