...
using cardsectionprocessor.application;
using cardsectionprocessor.application.Configuration;
using cardsectionprocessor.Extensions.WindowsService;
using cardsectionprocessor.infrastructure;
using cardsectionprocessor.Services;
...
namespace cardsectionprocessor
{
        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            var hostBuilder = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    // hosted service
                    services.AddHostedService<CardSectionProcessorHostedService>();
