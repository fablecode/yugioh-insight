...
{
    public class CardTipsWorkerService : IHostedService
    {
        public IServiceProvider Services { get; }

        private readonly IOptions<AppSettings> _options;
        private readonly ILogger<CardTipsWorkerService> _logger;
        private IScheduler _scheduler;

        public CardTipsWorkerService
        (
            IServiceProvider services,
            IOptions<AppSettings> options,
            ILogger<CardTipsWorkerService> logger
        )
        {
            Services = services;
            _options = options;
