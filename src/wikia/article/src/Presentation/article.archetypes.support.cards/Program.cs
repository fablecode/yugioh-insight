...
using article.archetypes.support.cards.Extensions.WindowsService;
using article.archetypes.support.cards.QuartzConfiguration;
using article.archetypes.support.cards.Services;
...
namespace article.archetypes.support.cards
{
