...
using banlistdata.application;
using banlistdata.application.Configuration;
using banlistdata.Extensions.WindowsService;
using banlistdata.infrastructure;
using banlistdata.Services;
        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            var hostBuilder = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    // hosted service
                    services.AddHostedService<BanlistDataHostedService>();
