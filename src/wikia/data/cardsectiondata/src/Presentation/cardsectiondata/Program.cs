...
using cardsectiondata.application;
using cardsectiondata.application.Configuration;
using cardsectiondata.Extensions.WindowsService;
using cardsectiondata.infrastructure;
using cardsectiondata.Services;
        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            var hostBuilder = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    // hosted service
                    services.AddHostedService<CardSectionDataHostedService>();
